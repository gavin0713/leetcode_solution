...
<p>&nbsp;</p>
<strong>Follow up:</strong> How would you extend your design to be generic and work with all types, not just integer?<div><div>Related Topics</div><div><li>设计</li><li>数组</li><li>迭代器</li></div></div><br><div><li>👍 140</li><li>👎 0</li></div>