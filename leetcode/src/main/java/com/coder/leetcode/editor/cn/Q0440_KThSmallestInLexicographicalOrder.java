...
// 1 <= k <= n <= 10⁹ 
// 
// Related Topics 字典树 👍 241 👎 0

package com.coder.leetcode.editor.cn;
public class Q0440_KThSmallestInLexicographicalOrder {
    public static void main(String[] args) {
        Solution solution = new Q0440_KThSmallestInLexicographicalOrder().new Solution();
    }
